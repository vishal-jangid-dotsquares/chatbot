...
class Rag:
    ...
    async def _refine_retriever(self, division:DIVISION_TYPE, retriever) -> DummyRetriever:     
        ...
        if self.is_userId_attached: 
            relevant_docs = self._user_base_filter_documents(division, relevant_docs)
    ...
    def _user_base_filter_documents(
            self, 
        ...
        for doc in documents:
            ...
            if re.search(userId_key_value_pattern, doc.page_content, re.IGNORECASE):
    ...
    def __attach_userId(self) -> str:
        ...
        if (self.userId 
            and re.search(self_reffering_pattern, self.message) 
    ...
    def __greeting_handler(self) -> str:
