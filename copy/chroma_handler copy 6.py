...
class ChromaDBPopulator:
    ...
    async def populate_chroma_db(self):
        ...
        try:
            # # # Load Tables
            await self._load_tables_data()

            # # # Load Documents
            # await self._load_documents_data()
            
            # Load website content
            # await self._load_websites_content_data()
    ...
    # Document loader
    async def _load_documents_data(self):
    ...
    async def _load_tables_data(self):
    ...
    async def _load_websites_content_data(self):     
        try:
